...
# Write-Output "Get-ADUser -SearchBase $contextIn -filter "$SEARCH_STRING"   | Select-Object SamAccountName"
...
# Write-Output "LIST LENGTH = $USER_LIST_ONE_LENGTH"
