...
if($DescriptionSet){
    ...
    if(!($AddToExchange)){
    UpdateCreatedUserProperty $SamAccountNameIn "Description" "$Description" "Description"
    }else{
...
if($DepartmentNameSet){
    ...
    if(!($AddToExchange)){
    UpdateCreatedUserProperty $SamAccountNameIn "Department" "$DepartmentName" "Department Name"
    }else{
...
if($TitleSet){
    ...
    if(!($AddToExchange)){
    UpdateCreatedUserProperty $SamAccountNameIn "Title" "$Title" "Title"
    }else{
...
if($MobilePhoneSet){
    ...
    if(!($AddToExchange)){
    UpdateCreatedUserProperty $SamAccountNameIn "MobilePhone" "$MobilePhone" "Mobile Phone"
    }else{
...
if($OfficePhoneSet){
    ...
    if(!($AddToExchange)){
    UpdateCreatedUserProperty $SamAccountNameIn "OfficePhone" "$OfficePhone" "Office Phone"
    }else{
