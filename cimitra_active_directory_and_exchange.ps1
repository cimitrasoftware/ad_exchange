...
$SettingsConfigFileEmpty = [string]::IsNullOrWhiteSpace($SettingsConfigFile)

if($SettingsConfigFileEmpty){
...
if(!($ExcludeGroupGUID.Length -gt 2)){
...
# Map the $context variable to the AD_EXCLUDE_GROUP variable read in from the settings.cfg file
    if ($excludeGroupTest = "$CONFIG$AD_EXCLUDE_GROUP"){
        ...
        $Global:THE_AD_EXLUDE_GROUP  = "$AD_EXCLUDE_GROUP"
...
$Global:THE_AD_EXCLUDE_GROUP  = (Get-ADGroup $ExcludeGroupGUID).DistinguishedName
$Global:AD_EXCLUDE_GROUP = "$THE_AD_EXCLUDE_GROUP"
$Global:TheExcludeGroup = "$THE_AD_EXCLUDE_GROUP"
}
...
# Reassign parameters
$global:UserFirstName = $FirstName.Trim()
$global:UserLastName = $LastName.Trim()
$global:UserFirstName = $FirstName.Trim()
$global:SamAccountName = $SamAccountName.Trim()
$global:sleepTime = 5
...
$ExcludeGroupEmpty = [string]::IsNullOrWhiteSpace($THE_AD_EXCLUDE_GROUP)
            ...
            if(!($ExcludeGroupEmpty)){
                ...
                if($SkipUserSamAccountNameDisplay){
                        ...
                        if(!( $ShowDistinguishedName)){
                                ...
                                (Get-ADUser -Searchbase $contextIn -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname  | Format-Table -HideTableHeaders
                         }else{
                                (Get-ADUser -Searchbase $contextIn -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname,DistinguishedName  | Format-Table -HideTableHeaders
                         }
                    }else{
                         ...
                         if(!($ShowDistinguishedName)){
                                ...
                                (Get-ADUser -Searchbase $contextIn -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname,SamAccountName,DistinguishedName  | Format-Table -HideTableHeaders
                            }
                }
                ...
                if($SkipUserSamAccountNameDisplay){
                        ...
                        if(!($ShowDistinguishedName)){
                                Get-ADUser -Filter * -Searchbase $contextIn  -ErrorAction Stop | select Givenname,Surname | Format-Table -HideTableHeaders
                            }else{
                                Get-ADUser -Filter * -Searchbase $contextIn  -ErrorAction Stop | select Givenname,Surname,DistinguishedName | Format-Table -HideTableHeaders
                            }
                }else{
                        if(!($ShowDistinguishedName)){
                                Get-ADUser -Filter * -Searchbase $contextIn  -ErrorAction Stop | select Givenname,Surname,SamAccountName  | Format-Table -HideTableHeaders
                        }else{
                                Get-ADUser -Filter * -Searchbase $contextIn  -ErrorAction Stop | select Givenname,Surname,SamAccountName,DistinguishedName  | Format-Table -HideTableHeaders
                        }
                }
            }
        }catch{}
        ...
        try{
                if(!($ExcludeGroupEmpty)){
                        ...
                        if($SkipUserSamAccountNameDisplay){
                                ...
                                if(!($ShowDistinguishedName)){
                                    (Get-ADUser -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname  | Format-Table -HideTableHeaders
                                }else{
                                    (Get-ADUser -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname,DistinguishedName  | Select @{Name="First Name";Expression={$_.GivenName}},@{Name="Last Name";Expression={$_.Surname}},@{Name="Distinguished Name";Expression={$_.DistinguishedName}} | fl
                                }
                        }else{
                                if(!($ShowDistinguishedName)){
                                        (Get-ADUser -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname,SamAccountName  | Format-Table -HideTableHeaders
                                    }else{
                                        (Get-ADUser -ErrorAction Stop -Filter {objectclass -eq "user"} -properties memberof).where{$_.memberof -notcontains $THE_AD_EXCLUDE_GROUP} | select Givenname,Surname,SamAccountName,DistinguishedName  | Select @{Name="First Name";Expression={$_.GivenName}},@{Name="Last Name";Expression={$_.Surname}},@{Name="UserID";Expression={$_.SamAccountName}},@{Name="Distinguished Name";Expression={$_.DistinguishedName}} | fl
                                    }
                        }
                    }else{
                        if($SkipUserSamAccountNameDisplay){
                                  ...
                                  if(!($ShowDistinguishedName)){
                                        Get-ADUser -Filter * -ErrorAction Stop | select Givenname,Surname  | Format-Table -HideTableHeaders
                                  }else{
                                        Get-ADUser -Filter * -ErrorAction Stop | select Givenname,Surname,DistinguishedName  | Format-Table -HideTableHeaders
                                  }
                        }else{
                                  if(!($ShowDistinguishedName)){
                                        Get-ADUser -Filter * -ErrorAction Stop | select Givenname,Surname,SamAccountName  | Format-Table -HideTableHeaders
                                  }else{
                                        Get-ADUser -Filter * -ErrorAction Stop | select Givenname,Surname,SamAccountName,DistinguishedName   | Select @{Name="First Name";Expression={$_.GivenName}},@{Name="Last Name";Expression={$_.Surname}},@{Name="UserID";Expression={$_.SamAccountName}},@{Name="Distinguished Name";Expression={$_.DistinguishedName}} | fl
                                  }
                        }
                    }
        }catch{}
...
try{
$TheUserObject = Get-ADUser -Filter { SamAccountName -eq $TheSamAccountName } -SearchBase "$UserContextIn" 
}catch{}
...
$groupDN = $group.DistinguishedName
        ...
        try{$userDetails = Get-ADUser -Identity $user -Properties MemberOf}catch{} 
...
try{
$TheUserObject = Get-ADUser -Identity "CN=$UserFirstName $UserLastName,$UserContextIn"
}catch{}
 ...
 if($MobilePhoneSet){
    if($SEARCH_ATTRIBUTE_COUNTER -eq 0 ){
        if($WildCardSearch){
            ...
            $NEW_STRING="(Mobile -like '$MobilePhone*')"
        }else{
            $NEW_STRING="(Mobile -like '$MobilePhone')"
        }
        $SEARCH_STRING = $SEARCH_STRING+$NEW_STRING
        $SEARCH_ATTRIBUTE_COUNTER++
            ...
            if($WildCardSearch){
                $NEW_STRING=" -and (Mobile -like '$MobilePhone*')"
            }else{
                $NEW_STRING=" -and (Mobile -like '$MobilePhone')"
            }
 ...
 if($OfficePhoneSet){
    ...
    if($SEARCH_ATTRIBUTE_COUNTER -eq 0 ){
        if($WildCardSearch){
            ...
            $NEW_STRING="(TelephoneNumber -like '$OfficePhone*')"
        }else{
        ...
        $SEARCH_ATTRIBUTE_COUNTER++
            ...
            if($WildCardSearch){
                $NEW_STRING=" -and (TelephoneNumber -like '$OfficePhone*')"
            }else{
                $NEW_STRING=" -and (TelephoneNumber -like '$OfficePhone')"
            }
...
# Write-Output "D1"
# Get-ADUser -SearchBase "$contextIn" -filter `{$SEARCH_STRING`}  | Select-Object SamAccountName | Export-CSV -NoTypeInformation  -Path c:\cimitra\scripts\ad_dev\out1.txt
# Write-Output "D2"
$ContextInEmpty = [string]::IsNullOrWhiteSpace($contextIn)

 try{
        if($ContextInEmpty){
            Get-ADUser -filter "$SEARCH_STRING"   | Select-Object SamAccountName  | Export-CSV -NoTypeInformation  -Path $TEMP_FILE_ONE
        }else{
            Get-ADUser -SearchBase "$contextIn" -filter "$SEARCH_STRING"   | Select-Object SamAccountName  | Export-CSV -NoTypeInformation  -Path $TEMP_FILE_ONE
        }
